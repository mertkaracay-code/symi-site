      ...
      <section className="max-w-7xl mx-auto pt-40 pb-24 grid md:grid-cols-2 gap-16 relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed">
            Connecting companies with international investors, financial institutions and strategic partners.
          </p>
        </div>

        <div>
          <div className="sticky top-32 overflow-hidden rounded-2xl group">
            <img src="/services/partnership.jpg" className="w-full h-[500px] object-cover group-hover:scale-105 transition duration-700"/>
          </div>
        </div>
