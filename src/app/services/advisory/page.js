      ...
      <section className="max-w-7xl mx-auto pt-40 pb-24 grid md:grid-cols-2 gap-16 relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed">
            Supporting companies in improving financial structures, corporate governance and sustainable business models.
          </p>
        </div>

        <div>
          <div className="sticky top-32 overflow-hidden rounded-2xl group">
            <img src="/services/advisory.jpg" className="w-full h-[500px] object-cover group-hover:scale-105 transition duration-700"/>
          </div>
        </div>
