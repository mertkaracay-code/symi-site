export const content = {
  ...
  en: {
    ...
    servicesDetail: {
      ma: `Comprehensive advisory services covering target identification, valuation, deal structuring, negotiation support, due diligence coordination and transaction execution.`,
      investment: `Supporting investors in identifying and evaluating investment opportunities across multiple sectors.`,
      corporate: `Financial structuring, capital raising, financial modeling and strategic financial planning services.`,
      partnership: `Connecting companies with international investors, financial institutions and strategic partners.`,
      advisory: `Supporting companies in improving financial structures, corporate governance and sustainable business models.`
    },

    contact: {
      address: "İÇERENKÖY MAH. TOPÇU İBRAHİM SK. AND PLAZA APT. NO:8-10D ATAŞEHİR, İSTANBUL, TÜRKİYE",
      phone: "0216 384 01 33",
      email: "info@symi.tr"
    }
  },
  ...
  tr: {
    ...
    services: [
      ...
      "Finansal ve İş Danışmanlığı"
    ],

    servicesDetail: {
      ma: `Hedef şirket belirleme, değerleme, işlem yapılandırma, müzakere desteği, due diligence koordinasyonu ve işlem tamamlanması.`,
      investment: `Yatırım fırsatlarının belirlenmesi ve değerlendirilmesi konusunda yatırımcılara destek.`,
      corporate: `Finansal yapılandırma, sermaye temini, finansal modelleme ve stratejik finansal planlama hizmetleri.`,
      partnership: `Şirketlerin uluslararası yatırımcılar ve stratejik ortaklarla buluşturulması.`,
      advisory: `Şirketlerin finansal yapılarının güçlendirilmesi ve sürdürülebilir iş modellerinin geliştirilmesi.`
    },
